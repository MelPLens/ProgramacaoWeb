...
//0.30000000000000004 e retorne R$0,30 (observe a vírgula e o ponto).(Utilizar arrow function).

const formatarDinheiro = valor => {
    const valorFormatado = valor.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' }); //padrao BR para real
